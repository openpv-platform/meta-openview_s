# NB: This recipe was copied entirely from ./meta-openembedded/meta-oe/recipes-devtools/protobuf/protobuf_3.11.4.bb
# and updated to grab version 3.13 of protobuf in order to be compatible with esp-hosted
...
SRC_URI = "git://github.com/google/protobuf.git;branch=3.13.x \
           file://run-ptest \
