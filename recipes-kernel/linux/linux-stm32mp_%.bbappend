...
KERNEL_CONFIG_FRAGMENTS += "${WORKDIR}/fragments/fragment_01_enable_j1939.cfg \
                            ...
                            ${WORKDIR}/fragments/fragment_17_add_usb_serial.cfg \
                            ${WORKDIR}/fragments/fragment_18_enable_rtc.cfg \
                            "
...
SRC_URI:append = " \
                  ...
                  file://fragments/fragment_17_add_usb_serial.cfg \
                  file://fragments/fragment_18_enable_rtc.cfg \
                  "
